...
const HINDU_CALENDAR_FIRST_POINT = "It's not actually changing! Diwali and other festivals are based off the Hindu calendar which has a different astronomical basis than the Gregorian calendar";
const HINDU_CALENDAR_SECOND_POINT = "The Gregorian calendar (solar) tracks Earth's journey around the Sun, while the Hindu calendar (lunisolar) also considers the Moon's phases and positions";
const HINDU_CALENDAR_THIRD_POINT = "Here are a couple other things to keep in mind:";
